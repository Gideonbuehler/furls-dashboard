...
**Helpful Information:**
8. Does test session (99/88) appear on dashboard? (Y/N)
9. Does console show upload success? (Y/N)
10. Any error messages? (Copy exact text)
11. Tried different browsers? (Y/N)
12. Works for others on same network? (Y/N)
