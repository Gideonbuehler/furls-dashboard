    ...
    <div className="dashboard">
      <div className="stats-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <h3>Avg Speed</h3>
            <div className="stat-value">{currentStats?.averageSpeed?.toFixed(0) || 0}</div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <h3>Boost Used</h3>
            <div className="stat-value">{currentStats?.boostUsed?.toFixed(0) || 0}</div>
            <div className="stat-detail">Total collected: {currentStats?.boostCollected?.toFixed(0) || 0}</div>
          </div>
        </div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <h3>Session Time</h3>
            <div className="stat-value">{formatTime(currentStats?.gameTime || 0)}</div>
            <div className="stat-detail">Possession: {currentStats?.possessionTime?.toFixed(1) || 0}s</div>
          </div>
        </div>
      </div>
        ...
        <div className="all-time-stats">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card secondary">
              ...
              <div className="stat-value">{allTimeStats.avgAccuracy?.toFixed(1)}%</div>
            </div>
            <div className="stat-card secondary">
              <h4>Average Speed</h4>
              <div className="stat-value">{allTimeStats.avgSpeed?.toFixed(0)}</div>
            </div>
            <div className="stat-card secondary">
              <h4>Total Play Time</h4>
              <div className="stat-value">{formatTime(allTimeStats.totalPlayTime)}</div>
            </div>
          </div>
        </div>
      )}
